...
<p align="center">
    ...
    <p align="center">
        <a href="https://github.com/jmzwcn/req/actions/workflows/ci.yml?query=branch%3Amaster"><img src="https://github.com/jmzwcn/req/actions/workflows/ci.yml/badge.svg" alt="Build Status"></a>
        <a href="https://goreportcard.com/report/github.com/jmzwcn/req/v3"><img src="https://goreportcard.com/badge/github.com/jmzwcn/req/v3" alt="Go Report Card"></a>
        <a href="https://pkg.go.dev/github.com/jmzwcn/req/v3"><img src="https://pkg.go.dev/badge/github.com/jmzwcn/req/v3.svg"></a>
        <a href="LICENSE"><img src="https://img.shields.io/github/license/imroc/req.svg" alt="License"></a>
        <a href="https://github.com/jmzwcn/req/releases"><img src="https://img.shields.io/github/v/release/imroc/req?display_name=tag&sort=semver" alt="GitHub Releases"></a>
...
``` sh
go get github.com/jmzwcn/req/v3
```
...
```go
import "github.com/jmzwcn/req/v3"
```
...
:path: /uuid
:scheme: https
user-agent: req/v3 (https://github.com/jmzwcn/req/v3)
...
func main() {
  ...
  resp, err := client.R().
    SetBody(&Repo{Name: "req", Url: "https://github.com/jmzwcn/req"}).
...
{"name":"req","website":"https://github.com/jmzwcn/req"}
...
{
  "args": {},
  "data": "{\"name\":\"req\",\"website\":\"https://github.com/jmzwcn/req\"}",
  "files": {},
  "form": {},
  "headers": {
    "Accept-Encoding": "gzip",
  ...
  "json": {
    "name": "req",
    "website": "https://github.com/jmzwcn/req"
  },
  "origin": "103.7.29.30",
...
++++++++++++++++++++++++++++++++++++++++++++++++
data: {"name":"req","url":"https://github.com/jmzwcn/req"}
++++++++++++++++++++++++++++++++++++++++++++++++
```
...
If you have a bug report or feature request, you can [open an issue](https://github.com/jmzwcn/req/issues/new), and [pull requests](https://github.com/jmzwcn/req/pulls) are also welcome.

## Contact

If you have questions, feel free to reach out to us in the following ways:

* [Github Discussion](https://github.com/jmzwcn/req/discussions)
